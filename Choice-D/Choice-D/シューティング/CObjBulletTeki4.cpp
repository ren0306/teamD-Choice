...
//コンストラクタ
CObjBulletTeki4::CObjBulletTeki4(float x, float y)
{
	m_x = x;
	m_y = y;
}
...
void CObjBulletTeki4::Init()
{
	...
	//当たり判定用HitBoxを作成
	Hits::SetHitBox(this, m_x, m_y, 32, 32, ELEMENT_ENEMY, OBJ_BULLET_TEKI4, 1);
}

//アクション
void CObjBulletTeki4::Action()
{
	//Resourcesの描画物のRECT
