...
//コンストラクタ
CObjBulletTeki3::CObjBulletTeki3(float x, float y)
{
	m_x = x;
	m_y = y;
}
...
void CObjBulletTeki3::Init()
{
	...
	//当たり判定用HitBoxを作成
	Hits::SetHitBox(this, m_x, m_y, 32, 32, ELEMENT_ENEMY, OBJ_BULLET_TEKI3, 1);
}

//アクション
void CObjBulletTeki3::Action()
{
	//Resourcesの描画物のRECT
